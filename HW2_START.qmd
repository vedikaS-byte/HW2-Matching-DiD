...
wind_clean <- match_data %>% select(proposed_turbine_3km, log_home_val_07, p_uni_degree, log_median_inc, log_pop_denc)
...
*Response:* The `log_pop_denc` appears to be the most imbalanced covariate. The `log_median_inc` seems to be the most balanced covariates between years, as well as `log_home_val_07` and `p_uni_degree` .
